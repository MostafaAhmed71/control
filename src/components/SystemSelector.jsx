...
const SystemSelector = ({ onSelect }) => {
    return (
        <div className="min-h-screen bg-[#F1F3F9] flex items-center justify-center p-6 md:p-20 relative overflow-hidden font-alexandria" dir="rtl">
            ...
            <div className="max-w-7xl w-full space-y-20 relative z-10">
                ...
                <div className="text-center space-y-6 animate-in fade-in slide-in-from-top-12 duration-1000">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tight font-header leading-tight">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <button 
                        ...
                        className="group relative bg-white p-12 rounded-[4rem] shadow-premium border border-white hover:border-indigo-200 transition-all duration-700 hover:-translate-y-4 text-right overflow-hidden flex flex-col justify-between min-h-[500px]"
                    >
                        ...
                        <div className="relative z-10 space-y-8">
                            ...
                            <div className="space-y-4">
                                <h2 className="text-4xl font-black text-slate-900 font-header leading-tight group-hover:text-indigo-600 transition-colors">عالم شؤون الطلاب والتصحيح</h2>
                        ...
                        <div className="relative z-10 flex items-center gap-6 pt-10 border-t border-slate-50 mt-10">
                            <div className="flex -space-x-4 space-x-reverse">
                                {[Fingerprint, ScanLine, Trophy].map((Icon, i) => (
                    ...
                    <button 
                        ...
                        className="group relative bg-[#1E293B] p-12 rounded-[4rem] shadow-2xl border border-slate-800 hover:border-slate-700 transition-all duration-700 hover:-translate-y-4 text-right overflow-hidden flex flex-col justify-between min-h-[500px]"
                    >
                        ...
                        <div className="relative z-10 space-y-8">
                            ...
                            <div className="space-y-4">
                                <h2 className="text-4xl font-black text-white font-header leading-tight group-hover:text-indigo-400 transition-colors">منظومة كنترول اللجان</h2>
                                <p className="text-slate-400 font-bold text-lg leading-relaxed">
                        ...
                        <div className="relative z-10 flex items-center gap-6 pt-10 border-t border-white/5 mt-10">
                            <div className="flex -space-x-4 space-x-reverse">
                                {[UsersRound, CreditCard, Printer].map((Icon, i) => (
                ...
                <div className="flex flex-col items-center gap-6 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    <div className="flex items-center gap-8 py-4 px-10 bg-white rounded-[2rem] shadow-sm border border-slate-100">
